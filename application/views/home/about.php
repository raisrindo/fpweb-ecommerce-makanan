<div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="<?php base_url();?>home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">About</strong></div>
        </div>
      </div>
    </div>  
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-5">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black"> About MakananKite </h2>
            </div>
            <p> MakananKite merupakan suatu E-commerce yang baru berdiri pada November 2019. E-commerce ini didirikan oleh empat orang Mahasiswa Ilmu Komputer yaitu Achel, Aditya, Rais dan Redho dalam hal memenuhi tugas besar mata kuliah Pemrograman Web.</p>
            <p> MakananKite menyediakan berbagai macam jenis makanan khas betawi, mulai dari makanan ringan sampai makanan berat. Jadi untuk para pelanggan dari luar jakarta yang ingin menikmati produk-produk dari MakananKite namun tidak sedang berada di Jakarta, Tenang ! MakananKite solusinya !!!</p>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                ...
                <div class="block-38-body">
                  <p> Redho Saputra adalah seorang Manusia biasa yang saat ini merupakan seorang pengusaha sukses 
                      yang bergerak dibidang makanan. Redho sekarang sedang berfokus menjalankan bisnis makanannya 
                      yaitu MakananKite, Beliau merupakan salah satu lulusan dengan predikat terbaik di Universitas Bengkulu.  
                  </p>
                </div>
              </div>
            </div>
