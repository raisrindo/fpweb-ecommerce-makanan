<div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="<?php base_url();?>home">Home</a><span class="mx-2 mb-0">/</span> <strong class="text-black">Semprong</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="<?php base_url();?> assets/images/m_semprong.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Semprong</h2>
            <p>Kue semprong adalah makanan kue kering. Kue ini berbentuk selinder atau panjang seperti pipa dengan rasa yang khas dan unik.  rasa kue semprong juga sangat manis dan gurih. Dengan isian cokelat dan green tea</p>
            <p class="mb-4">Dengan komposisi tepung beras, santan kelapa, telur ayam, garam, wijen, tepung sagu, dan gula halus. Cocok untuk anda yang ingin makan makanan ringan yang renyah dan manis</p>
