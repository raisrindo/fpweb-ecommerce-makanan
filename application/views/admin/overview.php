...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url('https://fonts.googleapis.com/css?family=Amatic+SC:400,700&display=swap') ?>" rel="stylesheet">
  ...
  <body class="goto-here">
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url(images/bg_1.jpg);">
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-rollax-parent="true">
